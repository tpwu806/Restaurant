...
public class UpdCostNumDialog extends JDialog implements ActionListener{
	...
	JButton jb1,jb2;
	public UpdCostNumDialog(CostNum empInfo,String title,boolean model,EmpModel em,int rowNum)
	{
		super();
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		{
			String sql="update costnum set foodname=? ,materials=? , matscost=? , matsnum=? where foodid=?";
			String []params={jtf2.getText(),jtf3.getText(),jtf4.getText(),jtf5.getText(),jtf1.getText()};
